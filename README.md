...
1) Execute ```python3 generate_mcdonalds_plots.py -r [run number] -l [optional data limit: (n+1)*100,000 events within run number]``` to generate the "McDonalds" 2d plots of padID vs bx. The outputs will be generated in a folder called GEM_mcdonalds_data.
